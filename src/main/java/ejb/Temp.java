...
public class Temp {
	...
	private void createData() {
		...
		System.out.println(dao.getAll("address"));
		System.out.println(dao.getAll("bid"));
		System.out.println(dao.getAll("feedback"));
		System.out.println(dao.getAll("product"));
		System.out.println(dao.getAll("user"));
		System.out.println(dao.getAll("auction"));
